...
public class Optimizer {
    ...
    public static void main(String[] args) {
        ...
        execute.addActionListener(evt -> {
            ...
            int h=Visualizer.drawListOfTrees(tr.getAllVariants(),estimator,frame);
        ...
        // select A.a, B.b from A,B,C where A.a=B.b AND A.a='2' AND A.z='3' and C.c='3' OR A.a<'7' AND A.a>'89' OR C.e='45' OR C.j='35' AND B.b=C.b");
