...
public class Optimizer {
	...
	public static Node traitement(Node a){
		return new Node(a.getData()+"clone");
	}
	public static Node cloneTree(Node root) {
		if (root == null) {
			return null;
		}
		Node newNode =traitement(root);
	...
	public static void main(String[] args) {
		...
		Translator parsedTranslator = new Translator("select A.a, B.b from A,B where A.a=B.b"); //"SELECT CLIENT.ID FROM CLIENT WHERE CLIENT.ID='12'" select A.a, B.b from A,B,C where A.a=B.b AND A.a='2' OR C.c='3' AND B.b>'1' OR A.a<'7' AND B.b=C.b
		...
		//Translator.DrawTree(cloneTree(parsedTranslator.getTree()));
